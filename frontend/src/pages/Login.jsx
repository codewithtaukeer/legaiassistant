    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .auth-bg{position:fixed;inset:0;background:radial-gradient(ellipse 70% 50% at 50% 0%,rgba(201,168,76,0.07) 0%,transparent 70%),radial-gradient(ellipse 40% 40% at 80% 80%,rgba(139,115,85,0.05) 0%,transparent 60%);pointer-events:none}
        ...
        .auth-tagline{text-align:center;font-size:13px;color:var(--text3);margin-bottom:36px;font-style:italic;font-family:'Cormorant Garamond',serif;font-size:16px}
      ...
      <div className="auth-wrap">
        ...
        <div className="auth-card">
          ...
          <p className="auth-sub">Sign in to continue your legal research</p>
          ...
          <form onSubmit={handleSubmit}>
            <div className="auth-field">
              ...
              <input className="auth-input" placeholder="Enter your username" value={form.username}
                onChange={e => setForm({...form, username: e.target.value})} required />
            </div>
            <div className="auth-field">
              <label className="auth-label">Password</label>
              <input className="auth-input" type="password" placeholder="Enter your password" value={form.password}
